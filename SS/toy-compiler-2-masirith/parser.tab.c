...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_statement_list = 8,             /* statement_list  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "OPERATOR",
...
#line 37 "parser.y"
                     { (yyval.statement_list) = (yyvsp[0].statement_list); ast = (yyval.statement_list); }
...
#line 42 "parser.y"
                               { (yyval.statement_list) = create_statement_list((yyvsp[-1].statement), (yyvsp[0].statement_list)); }
#line 1084 "parser.tab.c"
    break;

  case 5: /* statement: expression ';'  */
#line 46 "parser.y"
                     { (yyval.statement) = create_statement((yyvsp[-1].expression)); }
#line 1090 "parser.tab.c"
    break;

  case 6: /* expression: NUMBER OPERATOR NUMBER  */
#line 50 "parser.y"
                             { (yyval.expression) = create_expression((yyvsp[-2].intval), (yyvsp[-1].charval), (yyvsp[0].intval)); }
